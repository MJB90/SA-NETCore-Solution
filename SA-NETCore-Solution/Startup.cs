...
namespace SA_NETCore_Solution
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DbSongs>(opt =>
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, [FromServices] DbSongs dbContext)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Search}/{action=Duration}/{id?}");
            });
